...
export const cep2026 = {
  ...
  cover: '/images/research/cep-2026/technical-roadmap.png',
  coverAlt: 'Technical roadmap for distributed observer-controller co-design and its LMI-based solution.',
  featuredImage: {
